async function getdata(lat,lon){  
    let url1=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=metric&appid=91efd692f9c9eb57f1196e9a5aa15596`;
...
async function search_val(){
    ...
    let url=`https://api.openweathermap.org/data/2.5/weather?q=${city}&units=metric&APPID=31f421e1d40ca76dc182cac3244b8551`
    try{
        let res=await fetch(url)
        let data=await res.json()
